...
function ContactUs() {
	...
	return (
		<section className='bg-[#748cab] pt-0 min-h-[calc(100vh-7rem)] '>
			<div class="grid lg:grid-cols-2 items-start gap-16 p-6 mx-auto max-w-full min-h-[calc(100vh-7rem)] max-lg:max-w-2xl  bg-white">
				<div>
					...
					<ul class="mt-4">
						<li class="flex items-center">
							...
							<a href="javascript:void(0)" class="text-sm ml-4">
								...
								<span class="font-semibold text-blue-600">info@example.com</span>
							</a>
						</li>
					</ul>
				</div>
      ...
      <form ref={form} onSubmit={sendEmail} className="lg:ml-auto space-y-4">
        <input 
			type="text"
			id="name"
			name="user_name"
        ...
        <button 
			...
			disabled={disableSubmit}
          	className="text-white bg-slate-900 hover:bg-slate-800 tracking-wide rounded-md text-sm font-medium px-4 py-3 w-full cursor-pointer !mt-2 border-0">
			Send message
		</button>
      </form>
    </div>		</section>

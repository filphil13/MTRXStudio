          ...
          <div className="mt-12">
            ...
            <ul className="mt-4">
              <li className="flex items-center">
                <div className="bg-[#334a5d] h-10 w-10 rounded-full flex items-center justify-center shrink-0 border border-sky-400/40">
                  <svg
                ...
                <a href="mailto:info@example.com" className="text-sm ml-4">
                  <small className="block text-slate-300">Mail</small>

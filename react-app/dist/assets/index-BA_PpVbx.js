...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ji,depthTest:!1,depthWrite:!1})}function m1(s,e,t){const r=new Float32Array(ns),o=new X(0,1,0);return new Di({name:"SphericalGaussianBlur",defines:{n:ns,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:o}},vertexShader:vc(),fragmentShader:`
	...
	`}class H0 extends Pi{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const r={width:e,height:e,depth:1},o=[r,r,r,r,r,r];this.texture=new C0(o),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const r={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},o=new ha(5,5,5),l=new Di({name:"CubemapFromEquirect",uniforms:ro(r.uniforms),vertexShader:r.vertexShader,fragmentShader:r.fragmentShader,side:Un,blending:Ji});l.uniforms.tEquirect.value=t;const u=new Wn(o,l),f=t.minFilter;return t.minFilter===is&&(t.minFilter=xn),new SS(1,10,this).update(e,u),t.minFilter=f,u.geometry.dispose(),u.material.dispose(),this}clear(e,t=!0,r=!0,o=!0){const l=e.getRenderTarget();for(let u=0;u<6;u++)e.setRenderTarget(this,u),e.clear(t,r,o);e.setRenderTarget(l)}}function g1(s){let e=new WeakMap,t=new WeakMap,r=null;function o(g,S=!1){return g==null?null:S?u(g):l(g)}function l(g){if(g&&g.isTexture){const S=g.mapping;if(S===lf||S===cf)if(e.has(g)){const M=e.get(g).texture;return f(M,g.mapping)}else{const M=g.image;if(M&&M.height>0){const A=new H0(M.height);return A.fromEquirectangularTexture(s,g),e.set(g,A),g.addEventListener("dispose",h),f(A.texture,g.mapping)}else return null}}return g}function u(g){if(g&&g.isTexture){const S=g.mapping,M=S===lf||S===cf,A=S===os||S===eo;if(M||A){let y=t.get(g);const x=y!==void 0?y.texture.pmremVersion:0;if(g.isRenderTargetTexture&&g.pmremVersion!==x)return r===null&&(r=new yg(s)),y=M?r.fromEquirectangular(g,y):r.fromCubemap(g,y),y.texture.pmremVersion=g.pmremVersion,t.set(g,y),y.texture;if(y!==void 0)return y.texture;{const C=g.image;return M&&C&&C.height>0||A&&C&&p(C)?(r===null&&(r=new yg(s)),y=M?r.fromEquirectangular(g):r.fromCubemap(g),y.texture.pmremVersion=g.pmremVersion,t.set(g,y),g.addEventListener("dispose",v),y.texture):null}}}return g}function f(g,S){return S===lf?g.mapping=os:S===cf&&(g.mapping=eo),g}function p(g){let S=0;const M=6;for(let A=0;A<M;A++)g[A]!==void 0&&S++;return S===M}function h(g){const S=g.target;S.removeEventListener("dispose",h);const M=e.get(S);M!==void 0&&(e.delete(S),M.dispose())}function v(g){const S=g.target;S.removeEventListener("dispose",v);const M=t.get(S);M!==void 0&&(t.delete(S),M.dispose())}function _(){e=new WeakMap,t=new WeakMap,r!==null&&(r.dispose(),r=null)}return{get:o,dispose:_}}function v1(s){const e={};function t(r){if(e[r]!==void 0)return e[r];const o=s.getExtension(r);return e[r]=o,o}return{has:function(r){return t(r)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(r){const o=t(r);return o===null&&fc("WebGLRenderer: "+r+" extension not supported."),o}}}function _1(s,e,t,r){const o={},l=new WeakMap;function u(_){const g=_.target;g.index!==null&&e.remove(g.index);for(const M in g.attributes)e.remove(g.attributes[M]);g.removeEventListener("dispose",u),delete o[g.id];const S=l.get(g);S&&(e.remove(S),l.delete(g)),r.releaseStatesOfGeometry(g),g.isInstancedBufferGeometry===!0&&delete g._maxInstanceCount,t.memory.geometries--}function f(_,g){return o[g.id]===!0||(g.addEventListener("dispose",u),o[g.id]=!0,t.memory.geometries++),g}function p(_){const g=_.attributes;for(const S in g)e.update(g[S],s.ARRAY_BUFFER)}function h(_){const g=[],S=_.index,M=_.attributes.position;let A=0;if(M===void 0)return;if(S!==null){const C=S.array;A=S.version;for(let P=0,R=C.length;P<R;P+=3){const k=C[P+0],I=C[P+1],O=C[P+2];g.push(k,I,I,O,O,k)}}else{const C=M.array;A=M.version;for(let P=0,R=C.length/3-1;P<R;P+=3){const k=P+0,I=P+1,O=P+2;g.push(k,I,I,O,O,k)}}const y=new(M.count>=65535?T0:E0)(g,1);y.version=A;const x=l.get(_);x&&e.remove(x),l.set(_,y)}function v(_){const g=l.get(_);if(g){const S=_.index;S!==null&&g.version<S.version&&h(_)}else h(_);return l.get(_)}return{get:f,update:p,getWireframeAttribute:v}}function x1(s,e,t){let r;function o(g){r=g}let l,u;function f(g){l=g.type,u=g.bytesPerElement}function p(g,S){s.drawElements(r,S,l,g*u),t.update(S,r,1)}function h(g,S,M){M!==0&&(s.drawElementsInstanced(r,S,l,g*u,M),t.update(S,r,M))}function v(g,S,M){if(M===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(r,S,0,l,g,0,M);let y=0;for(let x=0;x<M;x++)y+=S[x];t.update(y,r,1)}function _(g,S,M,A){if(M===0)return;const y=e.get("WEBGL_multi_draw");if(y===null)for(let x=0;x<g.length;x++)h(g[x]/u,S[x],A[x]);else{y.multiDrawElementsInstancedWEBGL(r,S,0,l,g,0,A,0,M);let x=0;for(let C=0;C<M;C++)x+=S[C]*A[C];t.update(x,r,1)}}this.setMode=o,this.setIndex=f,this.render=p,this.renderInstances=h,this.renderMultiDraw=v,this.renderMultiDrawInstances=_}function y1(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function r(l,u,f){switch(t.calls++,u){case s.TRIANGLES:t.triangles+=f*(l/3);break;case s.LINES:t.lines+=f*(l/2);break;case s.LINE_STRIP:t.lines+=f*(l-1);break;case s.LINE_LOOP:t.lines+=f*l;break;case s.POINTS:t.points+=f*l;break;default:Ct("WebGLInfo: Unknown draw mode:",u);break}}function o(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:o,update:r}}function S1(s,e,t){const r=new WeakMap,o=new Zt;function l(u,f,p){const h=u.morphTargetInfluences,v=f.morphAttributes.position||f.morphAttributes.normal||f.morphAttributes.color,_=v!==void 0?v.length:0;let g=r.get(f);if(g===void 0||g.count!==_){let se=function(){T.dispose(),r.delete(f),f.removeEventListener("dispose",se)};var S=se;g!==void 0&&g.texture.dispose();const M=f.morphAttributes.position!==void 0,A=f.morphAttributes.normal!==void 0,y=f.morphAttributes.color!==void 0,x=f.morphAttributes.position||[],C=f.morphAttributes.normal||[],P=f.morphAttributes.color||[];let R=0;M===!0&&(R=1),A===!0&&(R=2),y===!0&&(R=3);let k=f.attributes.position.count*R,I=1;k>e.maxTextureSize&&(I=Math.ceil(k/e.maxTextureSize),k=e.maxTextureSize);const O=new Float32Array(k*I*4*_),T=new y0(O,k,I,_);T.type=bi,T.needsUpdate=!0;const L=R*4;for(let B=0;B<_;B++){const ne=x[B],K=C[B],ae=P[B],q=k*I*4*B;for(let $=0;$<ne.count;$++){const V=$*L;M===!0&&(o.fromBufferAttribute(ne,$),O[q+V+0]=o.x,O[q+V+1]=o.y,O[q+V+2]=o.z,O[q+V+3]=0),A===!0&&(o.fromBufferAttribute(K,$),O[q+V+4]=o.x,O[q+V+5]=o.y,O[q+V+6]=o.z,O[q+V+7]=0),y===!0&&(o.fromBufferAttribute(ae,$),O[q+V+8]=o.x,O[q+V+9]=o.y,O[q+V+10]=o.z,O[q+V+11]=ae.itemSize===4?o.w:1)}}g={count:_,texture:T,size:new Ge(k,I)},r.set(f,g),f.addEventListener("dispose",se)}if(u.isInstancedMesh===!0&&u.morphTexture!==null)p.getUniforms().setValue(s,"morphTexture",u.morphTexture,t);else{let M=0;for(let y=0;y<h.length;y++)M+=h[y];const A=f.morphTargetsRelative?1:1-M;p.getUniforms().setValue(s,"morphTargetBaseInfluence",A),p.getUniforms().setValue(s,"morphTargetInfluences",h)}p.getUniforms().setValue(s,"morphTargetsTexture",g.texture,t),p.getUniforms().setValue(s,"morphTargetsTextureSize",g.size)}return{update:l}}function M1(s,e,t,r,o){let l=new WeakMap;function u(h){const v=o.render.frame,_=h.geometry,g=e.get(h,_);if(l.get(g)!==v&&(e.update(g),l.set(g,v)),h.isInstancedMesh&&(h.hasEventListener("dispose",p)===!1&&h.addEventListener("dispose",p),l.get(h)!==v&&(t.update(h.instanceMatrix,s.ARRAY_BUFFER),h.instanceColor!==null&&t.update(h.instanceColor,s.ARRAY_BUFFER),l.set(h,v))),h.isSkinnedMesh){const S=h.skeleton;l.get(S)!==v&&(S.update(),l.set(S,v))}return g}function f(){l=new WeakMap}function p(h){const v=h.target;v.removeEventListener("dispose",p),r.releaseStatesOfObject(v),t.remove(v.instanceMatrix),v.instanceColor!==null&&t.remove(v.instanceColor)}return{update:u,dispose:f}}const E1={[r0]:"LINEAR_TONE_MAPPING",[s0]:"REINHARD_TONE_MAPPING",[o0]:"CINEON_TONE_MAPPING",[a0]:"ACES_FILMIC_TONE_MAPPING",[c0]:"AGX_TONE_MAPPING",[u0]:"NEUTRAL_TONE_MAPPING",[l0]:"CUSTOM_TONE_MAPPING"};function T1(s,e,t,r,o){const l=new Pi(e,t,{type:s,depthBuffer:r,stencilBuffer:o}),u=new Pi(e,t,{type:er,depthBuffer:!1,stencilBuffer:!1}),f=new Xn;f.setAttribute("position",new ln([-1,3,0,-1,-1,0,3,-1,0],3)),f.setAttribute("uv",new ln([0,2,0,0,2,0],2));const p=new pS({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),h=new Wn(f,p),v=new z0(-1,1,1,-1,0,1);let _=null,g=null,S=!1,M,A=null,y=[],x=!1;this.setSize=function(C,P){l.setSize(C,P),u.setSize(C,P);for(let R=0;R<y.length;R++){const k=y[R];k.setSize&&k.setSize(C,P)}},this.setEffects=function(C){y=C,x=y.length>0&&y[0].isRenderPass===!0;const P=l.width,R=l.height;for(let k=0;k<y.length;k++){const I=y[k];I.setSize&&I.setSize(P,R)}},this.begin=function(C,P){if(S||C.toneMapping===Ri&&y.length===0)return!1;if(A=P,P!==null){const R=P.width,k=P.height;(l.width!==R||l.height!==k)&&this.setSize(R,k)}return x===!1&&C.setRenderTarget(l),M=C.toneMapping,C.toneMapping=Ri,!0},this.hasRenderPass=function(){return x},this.end=function(C,P){C.toneMapping=M,S=!0;let R=l,k=u;for(let I=0;I<y.length;I++){const O=y[I];if(O.enabled!==!1&&(O.render(C,k,R,P),O.needsSwap!==!1)){const T=R;R=k,k=T}}if(_!==C.outputColorSpace||g!==C.toneMapping){_=C.outputColorSpace,g=C.toneMapping,p.defines={},Rt.getTransfer(_)===Ut&&(p.defines.SRGB_TRANSFER="");const I=E1[g];I&&(p.defines[I]=""),p.needsUpdate=!0}p.uniforms.tDiffuse.value=R.texture,C.setRenderTarget(A),C.render(h,v),A=null,S=!1},this.isCompositing=function(){return S},this.dispose=function(){l.dispose(),u.dispose(),f.dispose(),p.dispose()}}const G0=new An,Bd=new oa(1,1),W0=new y0,X0=new cy,j0=new C0,Tg=[],wg=[],Ag=new Float32Array(16),bg=new Float32Array(9),Cg=new Float32Array(4);function ao(s,e,t){const r=s[0];if(r<=0||r>0)return s;const o=e*t;let l=Tg[o];if(l===void 0&&(l=new Float32Array(o),Tg[o]=l),e!==0){r.toArray(l,0);for(let u=1,f=0;u!==e;++u)f+=t,s[u].toArray(l,f)}return l}function tn(s,e){if(s.length!==e.length)return!1;for(let t=0,r=s.length;t<r;t++)if(s[t]!==e[t])return!1;return!0}function nn(s,e){for(let t=0,r=e.length;t<r;t++)s[t]=e[t]}function _c(s,e){let t=wg[e];t===void 0&&(t=new Int32Array(e),wg[e]=t);for(let r=0;r!==e;++r)t[r]=s.allocateTextureUnit();return t}function w1(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function A1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(tn(t,e))return;s.uniform2fv(this.addr,e),nn(t,e)}}function b1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(tn(t,e))return;s.uniform3fv(this.addr,e),nn(t,e)}}function C1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(tn(t,e))return;s.uniform4fv(this.addr,e),nn(t,e)}}function R1(s,e){const t=this.cache,r=e.elements;if(r===void 0){if(tn(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),nn(t,e)}else{if(tn(t,r))return;Cg.set(r),s.uniformMatrix2fv(this.addr,!1,Cg),nn(t,r)}}function P1(s,e){const t=this.cache,r=e.elements;if(r===void 0){if(tn(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),nn(t,e)}else{if(tn(t,r))return;bg.set(r),s.uniformMatrix3fv(this.addr,!1,bg),nn(t,r)}}function L1(s,e){const t=this.cache,r=e.elements;if(r===void 0){if(tn(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),nn(t,e)}else{if(tn(t,r))return;Ag.set(r),s.uniformMatrix4fv(this.addr,!1,Ag),nn(t,r)}}function N1(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function D1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(tn(t,e))return;s.uniform2iv(this.addr,e),nn(t,e)}}function I1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(tn(t,e))return;s.uniform3iv(this.addr,e),nn(t,e)}}function U1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(tn(t,e))return;s.uniform4iv(this.addr,e),nn(t,e)}}function F1(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function O1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(tn(t,e))return;s.uniform2uiv(this.addr,e),nn(t,e)}}function k1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(tn(t,e))return;s.uniform3uiv(this.addr,e),nn(t,e)}}function B1(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(tn(t,e))return;s.uniform4uiv(this.addr,e),nn(t,e)}}function z1(s,e,t){const r=this.cache,o=t.allocateTextureUnit();r[0]!==o&&(s.uniform1i(this.addr,o),r[0]=o);let l;this.type===s.SAMPLER_2D_SHADOW?(Bd.compareFunction=t.isReversedDepthBuffer()?Qd:Jd,l=Bd):l=G0,t.setTexture2D(e||l,o)}function V1(s,e,t){const r=this.cache,o=t.allocateTextureUnit();r[0]!==o&&(s.uniform1i(this.addr,o),r[0]=o),t.setTexture3D(e||X0,o)}function H1(s,e,t){const r=this.cache,o=t.allocateTextureUnit();r[0]!==o&&(s.uniform1i(this.addr,o),r[0]=o),t.setTextureCube(e||j0,o)}function G1(s,e,t){const r=this.cache,o=t.allocateTextureUnit();r[0]!==o&&(s.uniform1i(this.addr,o),r[0]=o),t.setTexture2DArray(e||W0,o)}function W1(s){switch(s){case 5126:return w1;case 35664:return A1;case 35665:return b1;case 35666:return C1;case 35674:return R1;case 35675:return P1;case 35676:return L1;case 5124:case 35670:return N1;case 35667:case 35671:return D1;case 35668:case 35672:return I1;case 35669:case 35673:return U1;case 5125:return F1;case 36294:return O1;case 36295:return k1;case 36296:return B1;case 35678:case 36198:case 36298:case 36306:case 35682:return z1;case 35679:case 36299:case 36307:return V1;case 35680:case 36300:case 36308:case 36293:return H1;case 36289:case 36303:case 36311:case 36292:return G1}}function X1(s,e){s.uniform1fv(this.addr,e)}function j1(s,e){const t=ao(e,this.size,2);s.uniform2fv(this.addr,t)}function Y1(s,e){const t=ao(e,this.size,3);s.uniform3fv(this.addr,t)}function q1(s,e){const t=ao(e,this.size,4);s.uniform4fv(this.addr,t)}function $1(s,e){const t=ao(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function Z1(s,e){const t=ao(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function K1(s,e){const t=ao(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function J1(s,e){s.uniform1iv(this.addr,e)}function Q1(s,e){s.uniform2iv(this.addr,e)}function eT(s,e){s.uniform3iv(this.addr,e)}function tT(s,e){s.uniform4iv(this.addr,e)}function nT(s,e){s.uniform1uiv(this.addr,e)}function iT(s,e){s.uniform2uiv(this.addr,e)}function rT(s,e){s.uniform3uiv(this.addr,e)}function sT(s,e){s.uniform4uiv(this.addr,e)}function oT(s,e,t){const r=this.cache,o=e.length,l=_c(t,o);tn(r,l)||(s.uniform1iv(this.addr,l),nn(r,l));let u;this.type===s.SAMPLER_2D_SHADOW?u=Bd:u=G0;for(let f=0;f!==o;++f)t.setTexture2D(e[f]||u,l[f])}function aT(s,e,t){const r=this.cache,o=e.length,l=_c(t,o);tn(r,l)||(s.uniform1iv(this.addr,l),nn(r,l));for(let u=0;u!==o;++u)t.setTexture3D(e[u]||X0,l[u])}function lT(s,e,t){const r=this.cache,o=e.length,l=_c(t,o);tn(r,l)||(s.uniform1iv(this.addr,l),nn(r,l));for(let u=0;u!==o;++u)t.setTextureCube(e[u]||j0,l[u])}function cT(s,e,t){const r=this.cache,o=e.length,l=_c(t,o);tn(r,l)||(s.uniform1iv(this.addr,l),nn(r,l));for(let u=0;u!==o;++u)t.setTexture2DArray(e[u]||W0,l[u])}function uT(s){switch(s){case 5126:return X1;case 35664:return j1;case 35665:return Y1;case 35666:return q1;case 35674:return $1;case 35675:return Z1;case 35676:return K1;case 5124:case 35670:return J1;case 35667:case 35671:return Q1;case 35668:case 35672:return eT;case 35669:case 35673:return tT;case 5125:return nT;case 36294:return iT;case 36295:return rT;case 36296:return sT;case 35678:case 36198:case 36298:case 36306:case 35682:return oT;case 35679:case 36299:case 36307:return aT;case 35680:case 36300:case 36308:case 36293:return lT;case 36289:case 36303:case 36311:case 36292:return cT}}class fT{constructor(e,t,r){this.id=e,this.addr=r,this.cache=[],this.type=t.type,this.setValue=W1(t.type)}}class dT{constructor(e,t,r){this.id=e,this.addr=r,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=uT(t.type)}}class hT{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,r){const o=this.seq;for(let l=0,u=o.length;l!==u;++l){const f=o[l];f.setValue(e,t[f.id],r)}}}const Hf=/(\w+)(\])?(\[|\.)?/g;function Rg(s,e){s.seq.push(e),s.map[e.id]=e}function pT(s,e,t){const r=s.name,o=r.length;for(Hf.lastIndex=0;;){const l=Hf.exec(r),u=Hf.lastIndex;let f=l[1];const p=l[2]==="]",h=l[3];if(p&&(f=f|0),h===void 0||h==="["&&u+2===o){Rg(t,h===void 0?new fT(f,s,e):new dT(f,s,e));break}else{let _=t.map[f];_===void 0&&(_=new hT(f),Rg(t,_)),t=_}}}class ac{constructor(e,t){this.seq=[],this.map={};const r=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let u=0;u<r;++u){const f=e.getActiveUniform(t,u),p=e.getUniformLocation(t,f.name);pT(f,p,this)}const o=[],l=[];for(const u of this.seq)u.type===e.SAMPLER_2D_SHADOW||u.type===e.SAMPLER_CUBE_SHADOW||u.type===e.SAMPLER_2D_ARRAY_SHADOW?o.push(u):l.push(u);o.length>0&&(this.seq=o.concat(l))}setValue(e,t,r,o){const l=this.map[t];l!==void 0&&l.setValue(e,r,o)}setOptional(e,t,r){const o=t[r];o!==void 0&&this.setValue(e,r,o)}static upload(e,t,r,o){for(let l=0,u=t.length;l!==u;++l){const f=t[l],p=r[f.id];p.needsUpdate!==!1&&f.setValue(e,p.value,o)}}static seqWithValue(e,t){const r=[];for(let o=0,l=e.length;o!==l;++o){const u=e[o];u.id in t&&r.push(u)}return r}}function Pg(s,e,t){const r=s.createShader(e);return s.shaderSource(r,t),s.compileShader(r),r}const mT=37297;let gT=0;function vT(s,e){const t=s.split(`
`),r=[],o=Math.max(e-6,0),l=Math.min(e+6,t.length);for(let u=o;u<l;u++){const f=u+1;r.push(`${f===e?">":" "} ${f}: ${t[u]}`)}return r.join(`
`)}const Lg=new xt;function _T(s){Rt._getMatrix(Lg,Rt.workingColorSpace,s);const e=`mat3( ${Lg.elements.map(t=>t.toFixed(4))} )`;switch(Rt.getTransfer(s)){case lc:return[e,"LinearTransferOETF"];case Ut:return[e,"sRGBTransferOETF"];default:return dt("WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function Ng(s,e,t){const r=s.getShaderParameter(e,s.COMPILE_STATUS),l=(s.getShaderInfoLog(e)||"").trim();if(r&&l==="")return"";const u=/ERROR: 0:(\d+)/.exec(l);if(u){const f=parseInt(u[1]);return t.toUpperCase()+`

`+l+`

`+vT(s.getShaderSource(e),f)}else return l}function xT(s,e){const t=_T(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const yT={[r0]:"Linear",[s0]:"Reinhard",[o0]:"Cineon",[a0]:"ACESFilmic",[c0]:"AgX",[u0]:"Neutral",[l0]:"Custom"};function ST(s,e){const t=yT[e];return t===void 0?(dt("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+s+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ql=new X;function MT(){Rt.getLuminanceCoefficients(Ql);const s=Ql.x.toFixed(4),e=Ql.y.toFixed(4),t=Ql.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function ET(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Jo).join(`
`)}function TT(s){const e=[];for(const t in s){const r=s[t];r!==!1&&e.push("#define "+t+" "+r)}return e.join(`
`)}function wT(s,e){const t={},r=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let o=0;o<r;o++){const l=s.getActiveAttrib(e,o),u=l.name;let f=1;l.type===s.FLOAT_MAT2&&(f=2),l.type===s.FLOAT_MAT3&&(f=3),l.type===s.FLOAT_MAT4&&(f=4),t[u]={type:l.type,location:s.getAttribLocation(e,u),locationSize:f}}return t}function Jo(s){return s!==""}function Dg(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Ig(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const AT=/^[ \t]*#include +<([\w\d./]+)>/gm;function zd(s){return s.replace(AT,CT)}const bT=new Map;function CT(s,e){let t=yt[e];if(t===void 0){const r=bT.get(e);if(r!==void 0)t=yt[r],dt('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,r);else throw new Error("Can not resolve #include <"+e+">")}return zd(t)}const RT=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ug(s){return s.replace(RT,PT)}function PT(s,e,t,r){let o="";for(let l=parseInt(e);l<parseInt(t);l++)o+=r.replace(/\[\s*i\s*\]/g,"[ "+l+" ]").replace(/UNROLLED_LOOP_INDEX/g,l);return o}function Fg(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}const LT={[tc]:"SHADOWMAP_TYPE_PCF",[Zo]:"SHADOWMAP_TYPE_VSM"};function NT(s){return LT[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const DT={[os]:"ENVMAP_TYPE_CUBE",[eo]:"ENVMAP_TYPE_CUBE",[mc]:"ENVMAP_TYPE_CUBE_UV"};function IT(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":DT[s.envMapMode]||"ENVMAP_TYPE_CUBE"}const UT={[eo]:"ENVMAP_MODE_REFRACTION"};function FT(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":UT[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}const OT={[i0]:"ENVMAP_BLENDING_MULTIPLY",[Ax]:"ENVMAP_BLENDING_MIX",[bx]:"ENVMAP_BLENDING_ADD"};function kT(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":OT[s.combine]||"ENVMAP_BLENDING_NONE"}function BT(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:r,maxMip:t}}function zT(s,e,t,r){const o=s.getContext(),l=t.defines;let u=t.vertexShader,f=t.fragmentShader;const p=NT(t),h=IT(t),v=FT(t),_=kT(t),g=BT(t),S=ET(t),M=TT(l),A=o.createProgram();let y,x,C=t.glslVersion?"#version "+t.glslVersion+`

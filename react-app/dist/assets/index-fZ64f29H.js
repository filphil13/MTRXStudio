...
\r
										...
										`,children:"info@mtrx-studio.com"})]})]})}),he.jsx("div",{className:"mt-5 sm:mt-12 w-full max-w-md sm:max-w-none sm:w-1/2",children:he.jsxs("div",{className:`\r
								group flex items-center gap-4\r
								p-4 rounded-xl\r
								border border-cyber-border\r
								bg-cyber-surface/50 backdrop-blur-xl\r
